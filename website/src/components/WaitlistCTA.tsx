  ...
  return (
    <section id="waitlist" className="py-24 md:py-30 px-6 md:px-12 text-center">
      ...
      {status === "success" ? (
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row max-w-[460px] mx-auto border border-border-default rounded-lg overflow-hidden">
          <input
            type="email"
            value={email}
          ...
          <button
            type="submit"
            className="font-mono text-[10px] tracking-[3px] uppercase text-bg bg-burgundy px-7 py-4 border-t sm:border-t-0 sm:border-l border-border-default hover:bg-burgundy-light transition-colors duration-300"
          >
            {t("button")}
          </button>
        </form>
