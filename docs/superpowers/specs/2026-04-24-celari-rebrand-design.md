...
- [ ] **iOS Rebrand**
  ...
  - [ ] Phase E — V1 modal V3 rebuild (plan to be written) — ConfirmTx / WcApprove / WalletConnect / AddToken / AddNftContract / NftDetail migrated off V1; allows full V1 + V2 deletion.
